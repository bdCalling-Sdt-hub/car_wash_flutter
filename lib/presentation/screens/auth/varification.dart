                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                            onPressed: () {
                              if (authController.secondsRemaining.value == 0) {
                                //controller.secondsRemaining.value = 3;
                                // controller.startTimer();
                                authController.resendOTP().then((value) {
                                  if (value == false) {
                                    authController.timer.cancel();
                                    authController.secondsRemaining.value = 0;
                                  }
                                });
                              }
                            ...
                            child: CustomText(
                              text: authController.secondsRemaining.value == 0
                                  ? "Resend OTP".tr
                                  : "Resend OTP in ${authController.secondsRemaining}",
                              fontSize: Dimensions.getFontSizeSmall(context),
                            ))
                      ],
                    ),
